...
[![Quality gate status](https://sonarcloud.io/api/project_badges/measure?project=DevelopersCoffee_airo&metric=alert_status&branch=main)](https://sonarcloud.io/summary/new_code?id=DevelopersCoffee_airo&branch=main)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=DevelopersCoffee_airo&metric=coverage&branch=main)](https://sonarcloud.io/summary/overall?id=DevelopersCoffee_airo&branch=main)
[![Reliability rating](https://sonarcloud.io/api/project_badges/measure?project=DevelopersCoffee_airo&metric=reliability_rating&branch=main)](https://sonarcloud.io/summary/overall?id=DevelopersCoffee_airo&branch=main)
[![Security rating](https://sonarcloud.io/api/project_badges/measure?project=DevelopersCoffee_airo&metric=security_rating&branch=main)](https://sonarcloud.io/summary/overall?id=DevelopersCoffee_airo&branch=main)
...
- **Bring your own playlist** — Aika Stream ships no IPTV content and no bundled channels.
