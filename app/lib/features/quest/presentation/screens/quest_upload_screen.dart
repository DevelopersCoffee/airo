...
class _QuestUploadScreenState extends ConsumerState<QuestUploadScreen> {
  ...
  bool get _canCreate => !_isLoading && _titleController.text.trim().isNotEmpty;
            ...
            child: Column(
              ...
              children: [
                ...
                if (_selectedFiles.isEmpty)
                  Text(
                    'Files are optional. You can create a quest now and add context later.',
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: _canCreate ? _createQuest : null,
                    style: ElevatedButton.styleFrom(
