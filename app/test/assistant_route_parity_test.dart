...
/// `feature_mind`, and the hub moved from `/assistant` to `/mind` in Phase 3
/// of `docs/superpowers/plans/2026-08-07-airo-mind-ssot-plan.md`). Deep links,
/// notification payloads, and `goNamed` call sites resolve on these NAMES, so
/// every move is only correct if every one of them still resolves — and to
/// the same (now `/mind`-rooted) location.
const _preExtractionAssistantRoutes = <String, String>{
  'Assistant': '/mind',
  'assistant_chat': '/mind/chat',
  'agent_notifications': '/mind/notifications',
  'profile': '/mind/profile',
  'assistant_models': '/mind/models',
  'assistant_device_capabilities': '/mind/device-capabilities',
  'assistant_model_advisor': '/mind/model-advisor',
  'assistant_prompt_lab': '/mind/prompt-lab',
  'assistant_audio_scribe': '/mind/audio-scribe',
  'assistant_agent_skills': '/mind/skills',
  'assistant_mobile_actions': '/mind/mobile-actions',
  'Wellbeing': '/wellbeing',
};
