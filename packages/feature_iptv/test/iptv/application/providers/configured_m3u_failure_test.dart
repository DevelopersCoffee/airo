...
void main() {
  ...
  test('every configured Xtream source failing surfaces an error instead of an '
      'empty channel list', () async {
  ...
  test('iptvChannelsProvider reports the failure when Xtream is the only '
      'configured source and it is entirely unreachable', () async {
    final container = ProviderContainer(
      overrides: [
        sharedPreferencesProvider.overrideWithValue(prefs),
        configuredM3uChannelsProvider.overrideWith(
