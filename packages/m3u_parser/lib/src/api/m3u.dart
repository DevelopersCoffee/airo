...
// These functions are ignored because they are not marked as `pub`: `channel_aliases`, `channels_from_parse_result`, `first_extra`, `format_channel_name`, `is_attr_key_byte`, `is_private_or_local_host`, `list_extra`, `new`, `normalize_channel_name`, `normalize_logo_url`, `normalize_network_url`, `normalize_stream_url`, `parse_authority_host`, `parse_extinf`, `parse_ipv4`, `parse_line`, `parse_m3u_playlist_str_with_stats`, `parse_m3u_playlist_str`, `split_scheme`
