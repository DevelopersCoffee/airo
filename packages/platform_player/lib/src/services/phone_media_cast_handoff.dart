...
class PhoneMediaCastHandoff {
  ...
  // Wi-Fi dropping mid-session is a common real-device scenario the file
  // server's own idle timer wouldn't catch for up to two minutes: no client
  // traffic is generated by a dead network, but none was expected while the
  // receiver keeps playing either. This proactively tears the server down
  // the moment every reported interface goes to `none`, instead of waiting
