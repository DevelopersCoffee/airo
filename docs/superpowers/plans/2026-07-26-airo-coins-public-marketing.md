...
**Problem:** The public site centers Aika Stream and gives the developing Coins
module no clear, truthful place beside it.

**User / outcome:** A visitor can see Aika Stream and Airo Coins as focused modules
...
| Aika Stream is available | Available | Existing release evidence | Preserve BYOC boundary |
...
the umbrella, Aika Stream as available, and Airo Coins as in development. With
...
Aika Stream retains its product/release journey. Coins has no download CTA and
