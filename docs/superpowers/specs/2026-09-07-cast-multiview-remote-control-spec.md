...
The eight-layout mosaic library (spotlight / 1+3, 1+2, stacked split, etc.)
is now in product: `MultiviewLayoutKind` (8 kinds, all ≤ 4 sessions) plus
`multiview.set_layout`. See `MULTIVIEW_V1.md`.
