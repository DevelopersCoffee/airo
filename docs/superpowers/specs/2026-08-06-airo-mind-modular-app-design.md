...
**Pattern precedent:** Airo Coins (ADR-0010 package-first + `core_product_shell` SSOT contract), Aika Stream (`pubspec_tv.yaml` trimmed-dependency flavor)

## Goal

Ship "Airo Mind" as a full standalone modular app the way Aika Stream and Airo
