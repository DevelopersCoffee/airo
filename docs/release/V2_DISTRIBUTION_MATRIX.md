...
| Release manifest JSON | Required | Required | Required as release evidence | Maps each artifact to profile, package ID, version, build number, source ref, workflow run, and checksum. |
