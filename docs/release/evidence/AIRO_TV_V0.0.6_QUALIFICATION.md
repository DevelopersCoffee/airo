# Midas Stream v0.0.6 qualification ledger
...
| macOS TV build | `build-macos-tv.sh` with isolated TV Dart/CocoaPods locks; `Midas Stream.app` release build and deep code-sign verification | Pass (local validation signature) |
