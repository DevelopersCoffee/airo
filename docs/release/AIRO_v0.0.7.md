...
| Surface | State | Notes |
| --- | --- | --- |
| Airo TV BACK after playback (#1430) | **Available** (on the hard gate) | Closed in tree; requires Stick install + D-pad + BACK-after-playback evidence before this notes file is published. |
