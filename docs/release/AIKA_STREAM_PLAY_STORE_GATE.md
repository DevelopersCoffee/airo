...
## Play Console dual form-factor (`0.0.1+19`) then `0.0.2+20` / `0.0.2+21`

Play already consumed `versionCode` **18**, **19**, and **20**. The next Play
AAB is **21** (`0.0.2+21` in `app/pubspec_tv.yaml`). Never reuse 20.
...
Cut the 0.0.2+21 AAB via `.github/workflows/aika-stream-release.yml` **after**
this packet is green. Do not reuse versionCode 20.
