...
## Play Console dual form-factor (`0.0.1+19`) then `0.0.2+20` / `0.0.2+21` / `0.0.2+22`

Play already consumed `versionCode` **18**, **19**, **20**, and **21**. The next Play
AAB is **22** (`0.0.2+22` in `app/pubspec_tv.yaml`). Never reuse 21.
`versionName` stays `0.0.2` for this drop.
...
Cut the 0.0.2+22 AAB via `.github/workflows/aika-stream-release.yml` **after**
this packet is green. Do not reuse versionCode 21.
