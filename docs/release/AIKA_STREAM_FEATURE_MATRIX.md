...
| Split Screen / MultiView layouts | Supported on Android TV | One, side by side, and 2×2. Two-pane snaps 5/50/95 with an overlay hairline handle and equal-power mix. User-supplied streams only. |
