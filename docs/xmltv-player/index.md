...
title: "XMLTV Player — Add a Programme Guide to Your Playlist | Aika Stream"
description: "Aika Stream pairs your M3U/M3U8 playlist with an authorized XMLTV guide for programme data and clearer playback diagnostics. Open source, no bundled EPG."
eyebrow: "XMLTV guide player"
hero_title: "An XMLTV guide, paired with your own playlist."
lede: "Add an authorized XMLTV source next to your M3U/M3U8 playlist and Aika Stream uses it for programme data and more specific playback-recovery states — not just a generic error when a stream fails."
...
capabilities:
  ...
  - title: Guide hosting or generation
    text: Aika Stream does not host, generate, or edit XMLTV files — it consumes a source URL you already have.
    status: planned
...
faq:
  - q: "Does Aika Stream come with a built-in programme guide?"
    a: "No. Aika Stream ships no channels, playlists, subscriptions, or EPG data of its own. You supply an XMLTV source URL from a provider you are already authorized to use."
  - q: "What does the XMLTV guide actually change in Aika Stream?"
...
Aika Stream treats it as exactly that: an addition to a playlist you've
...
recovery states instead of a flat error, because Aika Stream has schedule
