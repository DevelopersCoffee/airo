...
title: "XMLTV Player — Add a Programme Guide to Your Playlist | Midas Stream"
description: "Midas Stream pairs your M3U/M3U8 playlist with an authorized XMLTV guide for programme data and clearer playback diagnostics. Open source, no bundled EPG."
eyebrow: "XMLTV guide player"
hero_title: "An XMLTV guide, paired with your own playlist."
lede: "Add an authorized XMLTV source next to your M3U/M3U8 playlist and Midas Stream uses it for programme data and more specific playback-recovery states — not just a generic error when a stream fails."
...
capabilities:
  ...
  - title: Guide hosting or generation
    text: Midas Stream does not host, generate, or edit XMLTV files — it consumes a source URL you already have.
    status: planned
...
related:
  ...
  - title: Set up Android TV or Google TV
    ...
    icon: tv
faq:
  - q: "Does Midas Stream come with a built-in programme guide?"
    a: "No. Midas Stream ships no channels, playlists, subscriptions, or EPG data of its own. You supply an XMLTV source URL from a provider you are already authorized to use."
  - q: "What does the XMLTV guide actually change in Midas Stream?"
...
Midas Stream treats it as exactly that: an addition to a playlist you've
...
recovery states instead of a flat error, because Midas Stream has schedule
