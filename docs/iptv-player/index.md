...
title: "IPTV Player — Open Source, Bring Your Own Playlist | Aika Stream"
description: "Aika Stream is an open-source IPTV player for Android TV and Fire TV. Load your own M3U/M3U8 playlist and XMLTV guide. No bundled channels, no subscription."
eyebrow: "Open-source IPTV player"
hero_title: "An IPTV player that ships with no channels."
lede: "Aika Stream plays the M3U/M3U8 playlist and XMLTV guide you already have. Nothing is bundled, nothing is sold, and the source is public."
primary_cta: "Download Aika Stream"
capabilities_title: "What Aika Stream does as an IPTV player"
capabilities:
  ...
  - title: Recording and cloud playlists
    text: Aika Stream does not record and does not run cloud playlist storage.
    status: planned
...
faq:
  - q: "Does Aika Stream come with channels or a free trial subscription?"
    a: "No. Aika Stream includes no channels, playlists, subscriptions, or media catalog. You bring an M3U/M3U8 playlist and, optionally, an XMLTV guide from a source you are already authorized to use."
  - q: "Is Aika Stream free and open source?"
    a: "Yes. Aika Stream is published under an open-source licence, and the full source is on GitHub."
  - q: "What devices does Aika Stream support?"
    a: "Android TV and Google TV are the primary supported platforms. Fire TV, phone/tablet, and macOS are available with documented limitations — see the device support table on the Aika Stream product page."
  - q: "Where do I get an M3U playlist or XMLTV guide to use with Aika Stream?"
    a: "Aika Stream does not provide one. Use a playlist or guide URL from a source you already have the rights to access."
---
