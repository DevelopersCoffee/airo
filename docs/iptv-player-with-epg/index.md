...
title: "IPTV Player with EPG — Programme Guide Built In | Midas Stream"
description: "Midas Stream supports an EPG (electronic programme guide) via XMLTV, paired with your own M3U/M3U8 playlist. Open source, no bundled guide data."
eyebrow: "IPTV player with EPG"
hero_title: "An IPTV player that supports a real programme guide."
lede: "Midas Stream supports an EPG through XMLTV — add a guide source next to your playlist and get programme data and clearer playback diagnostics, not just a bare channel list."
primary_cta: "Download Midas Stream"
capabilities_title: "EPG support, specifically"
capabilities:
  - title: XMLTV-based guide
    text: Midas Stream reads standard XMLTV feeds, the format most EPG and IPTV providers already publish.
    status: available
  ...
  - title: No guide data included
    text: Midas Stream does not publish, host, or bundle EPG/guide data of its own.
    status: planned
    status_label: Not supported
related_title: "Set it up"
related:
  - title: XMLTV setup and format details
    text: What Midas Stream does with the guide feed, and how pairing works.
    url: /xmltv-player/
    icon: calendar
...
faq:
  - q: "Does an IPTV player with EPG mean it comes with programme data included?"
    a: "No, not for Midas Stream. EPG support means Midas Stream can read a guide feed you provide — it does not publish or bundle programme data of its own."
  - q: "What guide format does Midas Stream's EPG support use?"
    a: "XMLTV, the standard format most EPG and IPTV providers already publish alongside their playlists."
  - q: "Is EPG required to use Midas Stream?"
...
the honest answer for Midas Stream is: yes, through XMLTV, and it's optional.
...
and Midas Stream still works exactly the same for playlist playback, search,
and favorites.

What it isn't: a source of guide data. Midas Stream doesn't publish or bundle
