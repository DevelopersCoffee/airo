# Spec: Aika Stream — Zero-Copy Cast & Adaptive Buffering Control
...
Aika Stream users buffer because community IPTV sources have no SLA and raw
...
**Users:** Aika Stream viewers on Android TV, Google TV, Fire TV (receivers) and
Aika Stream / Airo Coins-style companion use on Android/iOS phone (senders).
