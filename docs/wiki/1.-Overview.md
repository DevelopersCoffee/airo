...
Airo is a modular, local-first platform. Midas Stream is its first available focused
product. Other areas remain part of the Airo umbrella until published release
evidence establishes a different claim state.

It is built to:

- **Keep module status explicit:** Midas Stream is available; Airo Coins is in
