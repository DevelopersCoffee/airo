...
- Profile and **Intelligence** at `/assistant/profile` and
  `/assistant/models`. Intelligence is the task-first control center: pick a
  job (Chat, Scribe, Documents, Vision) and Airo selects the model.
