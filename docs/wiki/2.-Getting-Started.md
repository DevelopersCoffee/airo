...
|---|---|---|
| Aika Stream (GitHub v0.0.6) | `io.airo.app.tv` | [Airo-TV-0.0.6.apk](https://github.com/DevelopersCoffee/airo/releases/download/v0.0.6/Airo-TV-0.0.6.apk) |
| Aika Stream (Play Store, first listing) | `com.developerscoffee.tv.midas` | Not published yet — Pixel qualification next. See [Aika Stream Play Store gate](../release/MIDAS_STREAM_PLAY_STORE_GATE.md). |
...
| Aika Stream for macOS | — | [DMG](https://github.com/DevelopersCoffee/airo/releases/download/v0.0.6/Airo-TV-0.0.6-macOS.dmg) · [ZIP](https://github.com/DevelopersCoffee/airo/releases/download/v0.0.6/Airo-TV-0.0.6-macOS.zip) |

Aika Stream also publishes per-ABI APKs (`arm64-v8a`, `armeabi-v7a`, `x86_64`) for
