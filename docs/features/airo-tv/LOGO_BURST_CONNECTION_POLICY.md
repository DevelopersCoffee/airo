...
Do not add a custom HTTP/2 image fetch adapter for Aika Stream logo loading in the
current v2 slice.

Aika Stream channel cards render logos through Flutter image providers
...
- analyzer for the Aika Stream grid consumer
