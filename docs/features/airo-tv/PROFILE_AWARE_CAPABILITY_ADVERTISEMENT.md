# Aika Stream Profile-Aware Capability Advertisement

ATV-062 defines the reusable platform publication model that tells controllers,
routers, handoff flows, and diagnostics which Aika Stream capabilities are safe to
...
- Aika Stream app code consumes the platform advertisement and should not construct
...
## Default Aika Stream Advertisements
...
Aika Stream should use the platform advertisement before exposing remote-control
