...
**User / actor:** Airo TV user searching a channel library on phone, tablet,
desktop, or TV.
...
**Consumer agent:** Airo TV channel-library filter row and search overlay.
...
**Actor:** Airo TV user on a compact Pixel 9 viewport or TV.
