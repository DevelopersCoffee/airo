# Midas Stream Planning Index

Midas Stream is the v2 media-product direction for Airo: a bring-your-own-content
...
- [AIRO_TV_DEVICE_GUIDE.md](./AIRO_TV_DEVICE_GUIDE.md): device setup guide, tutorial structure, troubleshooting, and current/planned feature status for Midas Stream v2.
...
- Milestone: `v2.0.0.1 - Midas Stream Platform Hardening`
...
`v2.0.0.1` only as the Midas Stream platform-hardening planning milestone name.
