# Aika Stream Planning Index

Aika Stream is the v2 media-product direction for Airo: a bring-your-own-content
...
- [AIRO_TV_DEVICE_GUIDE.md](./AIRO_TV_DEVICE_GUIDE.md): device setup guide, tutorial structure, troubleshooting, and current/planned feature status for Aika Stream v2.
...
- Milestone: `v2.0.0.1 - Aika Stream Platform Hardening`
...
`v2.0.0.1` only as the Aika Stream platform-hardening planning milestone name.
