# Aika Stream Media Decoder Probe Matrix Contract

This contract defines the v2.0.0.1 platform probe matrix for Aika Stream media
...
evidence. Aika Stream app code may consume the report for playback fallback,
...
compatibility for Lite Receiver or legacy Aika Stream profiles.
