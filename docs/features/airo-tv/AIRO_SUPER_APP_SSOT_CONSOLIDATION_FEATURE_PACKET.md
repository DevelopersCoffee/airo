# Airo Super-App / Airo TV SSOT Consolidation Feature Packet

## Feature Packet

**Primary owner agent:** Chief Architect  
**Review agents:** Media Intelligence Architect, Airo TV Flutter Architect, Chief QA Officer, Chief Documentation Officer, Chief Release/DevOps Officer  
...
**Problem:** Airo and Airo TV already share parts of the IPTV stack, but they do
...
owned in different places. That allows Airo TV work to diverge from Airo and
forces manual duplication when a shared IPTV setting or menu option changes.

**User / actor:** Platform engineers, Airo TV feature engineers, release
...
Airo TV Flutter Architect (TV rendering and shell adoption), Chief QA Officer
...
**Consumer agent:** Airo TV Flutter Architect, super-app shell owners, release
tooling  
...
**Actor:** Airo TV feature engineer  
...
**Happy path:** Airo mobile settings and Airo TV settings both render the
...
#### UC-003: Airo TV modular work is adopted by the super-app without breakage
...
- rewire current Airo and Airo TV renderers
