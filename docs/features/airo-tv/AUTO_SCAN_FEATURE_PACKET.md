...
**Layer:** Mixed — reusable stream-probe contract plus the Aika Stream browse workflow
...
**User / actor:** An Aika Stream viewer managing their own M3U or configured source.
...
### Task 2: Aika Stream scan state and scheduler bridge (M)
...
- Update #969 and the Aika Stream feature documentation with the final contract,
