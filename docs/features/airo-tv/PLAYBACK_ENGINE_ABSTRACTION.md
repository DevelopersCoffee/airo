# Aika Stream Playback Engine Abstraction

This contract defines the v2.0.0.1 platform boundary for backend-agnostic
playback used by Aika Stream, IPTV, Cast, future native media engines, command
...
Aika Stream, IPTV features, command routing, route selection, and future
