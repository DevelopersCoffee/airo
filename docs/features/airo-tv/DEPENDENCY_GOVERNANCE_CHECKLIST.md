# Aika Stream Dependency Governance Checklist

This checklist defines the platform dependency-governance contract for Aika Stream
...
Every runtime dependency used by an Aika Stream release profile must declare:
...
A dependency can be accepted for a Lite Receiver or legacy Aika Stream profile only
