# Aika Stream Volume 3 Gap Analysis
...
Volume 3 moves Aika Stream from a TV app into a connected media platform. The
...
- There is no Aika Stream state schema for profiles, favorites, watch history,
