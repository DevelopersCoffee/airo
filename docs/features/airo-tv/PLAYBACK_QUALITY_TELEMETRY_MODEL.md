...
Aika Stream playback code may emit these typed events at product workflow points,
...
Aika Stream should convert playback runtime measurements into the platform bucket
