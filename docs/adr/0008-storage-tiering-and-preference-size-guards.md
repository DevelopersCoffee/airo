...
Hive is not the target storage tier for native Aika Stream data. The web database
...
5. Hive is not approved for new native Aika Stream persistence. Web storage must use
