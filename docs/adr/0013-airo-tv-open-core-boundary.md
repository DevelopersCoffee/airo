# ADR 0013: Airo TV open-core boundary
...
Airo TV must remain a complete self-hosted media player. Classification cannot
...
Airo TV Pro (`pro`) includes personalized intelligence, recommendation and
...
unqualified work is `Under qualification`; Airo TV Pro remains `In testing`
