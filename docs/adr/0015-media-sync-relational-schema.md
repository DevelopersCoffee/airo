...
schemas and is not the correct ownership boundary for Aika Stream media sync.
...
- Native/Dart adapters expose async relational read/write paths. No deployed
  Aika Stream media/sync blob schema exists in this repository, so there is no
